// Tests for Av1ForwardDct8Gpu.Forward8 driven through
// Av1ForwardDct8GpuKernel. Ensures the static helper - the building
// block Av1FrameSequentialEncodeKernel will use - produces output
// bit-exact vs Av1ForwardDct8.Transform across (a) zero, (b) DC-only,
// (c) random batches, (d) all cos_bit values 10..13.
...
public abstract partial class CodecsTestBase
{
    ...
    public async Task Av1ForwardDct8Gpu_RandomBatch_MatchesCpuReference()
    {
        ...
        try
        {
            ...
            var rng = new Random(unchecked((int)0xA1F8DC8Au));
    ...
    public async Task Av1ForwardDct8Gpu_AllCosBits_MatchCpuReference()
    {
        ...
        try
        {
            ...
            var rng = new Random(unchecked((int)0xFD8B0CAFu));
            var input = new int[transformCount * 8];
