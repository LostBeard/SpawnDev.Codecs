// Tests for Av1ForwardAdst16Kernel. Validates bit-exact match with
// Av1ForwardAdst16.Transform across (a) zero, (b) DC-only / structured,
...
{
    [TestMethod]
    public async Task Av1ForwardAdst16Kernel_ZeroInput_MatchesCpuReference()
    {
        var (ctx, acc) = await CreateKernelAcceleratorAsync();
        try
        {
            using var kernel = new Av1ForwardAdst16Kernel(acc);
    ...
    [TestMethod]
    public async Task Av1ForwardAdst16Kernel_DcOnlyInput_MatchesCpuReference()
    {
        var (ctx, acc) = await CreateKernelAcceleratorAsync();
        try
        {
    ...
    [TestMethod]
    public async Task Av1ForwardAdst16Kernel_RandomBatch_MatchesCpuReference()
    {
        var (ctx, acc) = await CreateKernelAcceleratorAsync();
        try
        {
    ...
    [TestMethod]
    public async Task Av1ForwardAdst16Kernel_AllCosBits_MatchCpuReference()
    {
        var (ctx, acc) = await CreateKernelAcceleratorAsync();
        try
        {
