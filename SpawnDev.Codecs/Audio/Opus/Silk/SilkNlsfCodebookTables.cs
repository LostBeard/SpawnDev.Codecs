...
//
// Structural port of libopus silk/tables_NLSF_CB_NB_MB.c and silk/tables_NLSF_CB_WB.c
// to clean C#. These are the NLSF quantization codebooks referenced at runtime by the
// SILK decoder for NB/MB frames (order 10) and WB frames (order 16).
//
...
/// <summary>
/// Runtime NLSF codebooks for SILK. <see cref="NbMb"/> handles NB and MB frames
/// (order 10, 32 first-stage vectors). <see cref="Wb"/> handles WB frames (order 16,
/// 32 first-stage vectors). Both tables match libopus bit-exactly.
/// </summary>
internal static class SilkNlsfCodebookTables
{
    // ============================ NB/MB data ============================

    private static readonly byte[] Cb1NbMbQ8 =
    {
    ...
    private static readonly short[] Cb1NbMbWghtQ9 =
    {
    ...
    private static readonly byte[] Cb1IcdfNbMb =
    {
    ...
    private static readonly byte[] Cb2SelectNbMb =
    {
    ...
    private static readonly byte[] Cb2IcdfNbMb =
    {
    ...
    private static readonly byte[] Cb2BitsNbMbQ5 =
    {
    ...
    private static readonly byte[] PredNbMbQ8 =
    {
        179, 138, 140, 148, 151, 149, 153, 151, 163,
        116,  67,  82,  59,  92,  72, 100,  89,  92,
    };

    private static readonly short[] DeltaMinNbMbQ15 =
    {
    ...
    private static readonly byte[] Cb1WbQ8 =
    {
    ...
    private static readonly short[] Cb1WbWghtQ9 =
    {
    ...
    private static readonly byte[] Cb1IcdfWb =
    {
    ...
    private static readonly byte[] Cb2SelectWb =
    {
    ...
    private static readonly byte[] Cb2IcdfWb =
    {
    ...
    private static readonly byte[] Cb2BitsWbQ5 =
    {
    ...
    private static readonly byte[] PredWbQ8 =
    {
        175, 148, 160, 176, 178, 173, 174, 164, 177, 174, 196, 182, 198, 192, 182,
         68,  62,  66,  60,  72, 117,  85,  90, 118, 136, 151, 142, 160, 142, 155,
    };

    private static readonly short[] DeltaMinWbQ15 =
    {
        100, 3, 40, 3, 3, 3, 5, 14, 14, 10, 11, 3, 8, 9, 7, 3, 347,
    };

    // ============================ Codebook instances ============================
    // Declared after their data arrays so static field initialization order is unambiguous.

    /// <summary>NLSF codebook for NB/MB frames (LPC order 10).</summary>
    internal static readonly SilkNlsfCodebook NbMb = new()
    {
        NVectors = 32,
        Order = 10,
        // SILK_FIX_CONST(0.18, 16) = (int)(0.18 * 65536 + 0.5) = 11796.
        QuantStepSizeQ16 = 11796,
        // SILK_FIX_CONST(1.0 / 0.18, 6)  = (int)((1/0.18) * 64 + 0.5) = 356.
        InvQuantStepSizeQ6 = 356,
        Cb1NlsfQ8 = Cb1NbMbQ8,
        Cb1WghtQ9 = Cb1NbMbWghtQ9,
        Cb1Icdf = Cb1IcdfNbMb,
        PredQ8 = PredNbMbQ8,
        EcSel = Cb2SelectNbMb,
        EcIcdf = Cb2IcdfNbMb,
        EcRatesQ5 = Cb2BitsNbMbQ5,
        DeltaMinQ15 = DeltaMinNbMbQ15,
    };

    /// <summary>NLSF codebook for WB frames (LPC order 16).</summary>
    internal static readonly SilkNlsfCodebook Wb = new()
    {
        NVectors = 32,
        Order = 16,
        // SILK_FIX_CONST(0.15, 16) = (int)(0.15 * 65536 + 0.5) = 9830.
        QuantStepSizeQ16 = 9830,
        // SILK_FIX_CONST(1.0 / 0.15, 6) = (int)((1/0.15) * 64 + 0.5) = 427.
        InvQuantStepSizeQ6 = 427,
        Cb1NlsfQ8 = Cb1WbQ8,
        Cb1WghtQ9 = Cb1WbWghtQ9,
        Cb1Icdf = Cb1IcdfWb,
        PredQ8 = PredWbQ8,
        EcSel = Cb2SelectWb,
        EcIcdf = Cb2IcdfWb,
        EcRatesQ5 = Cb2BitsWbQ5,
        DeltaMinQ15 = DeltaMinWbQ15,
    };
}
