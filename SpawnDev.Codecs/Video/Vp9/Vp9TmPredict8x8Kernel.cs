...
//
// 8x8 sibling of Vp9TmPredict4x4Kernel. Same per-pixel arithmetic
// (clip_pixel(above[c] + left[r] - topLeft)) over N=8.
...
/// </summary>
public sealed class Vp9TmPredict8x8Kernel : IDisposable
{
    ...
    public Vp9TmPredict8x8Kernel(Accelerator accelerator)
    {
