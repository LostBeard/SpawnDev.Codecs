...
//
// Test/integration kernel that drives the Av1InverseDct16Gpu.Inverse16
// static helper through ILGPU. Verifies the helper composes inside a
// kernel.
...
/// <see cref="Av1InverseDct16Gpu.Inverse16"/>.
/// </summary>
public sealed class Av1InverseDct16GpuKernel : IDisposable
{
    private readonly Accelerator _accelerator;
    private readonly Action<Index1D, ArrayView<int>, ArrayView<int>, int, int> _kernel;

    /// <summary>Compile.</summary>
    public Av1InverseDct16GpuKernel(Accelerator accelerator)
    {
        ArgumentNullException.ThrowIfNull(accelerator);
        _accelerator = accelerator;
        _kernel = accelerator.LoadAutoGroupedStreamKernel<
            Index1D, ArrayView<int>, ArrayView<int>, int, int>(IdctKernel);
    }

    /// <summary>Run on <paramref name="transformCount"/> 16-element transforms.</summary>
    public void Run(ArrayView<int> input, ArrayView<int> output, int transformCount, int cosBit = Av1InverseDct16Gpu.DefaultCosBit)
    {
        ...
        int cosBit)
    {
        ...
        Av1InverseDct16Gpu.Inverse16(input, inBase, output, outBase, cosBit);
    }
