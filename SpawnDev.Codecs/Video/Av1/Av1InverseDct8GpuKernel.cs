...
//
// Test/integration kernel that drives the Av1InverseDct8Gpu.Inverse8
...
/// <see cref="Av1InverseDct8Gpu.Inverse8"/>.
/// </summary>
public sealed class Av1InverseDct8GpuKernel : IDisposable
{
    private readonly Accelerator _accelerator;
    private readonly Action<Index1D, ArrayView<int>, ArrayView<int>, int, int> _kernel;

    /// <summary>Compile.</summary>
    public Av1InverseDct8GpuKernel(Accelerator accelerator)
    {
    ...
    public void Run(ArrayView<int> input, ArrayView<int> output, int transformCount, int cosBit = Av1InverseDct8Gpu.DefaultCosBit)
    {
        ...
        int cosBit)
    {
        ...
        Av1InverseDct8Gpu.Inverse8(input, inBase, output, outBase, cosBit);
    }
